...
import com.choonsky.orderman.repository.StateRepository;
...
public class ChiefController {
    ...
    public ModelAndView getChief() {

        ModelAndView modelAndView = new ModelAndView("chief");
...
// fetching all orders...
        List<State> states = new ArrayList<>(stateRepository.findByIdGreaterThanEqual(stateRepository.
                findByStateName("SENT").get().getId()));
        List<Order> orders = new ArrayList<>(orderRepository.findAllByStateIn(states));
